function CreateModels(SequelizeMod, sequelize, idPlanta) {
	...
	Usuarios.belongsTo(Plantas, {foreignKey:'idPlanta', as:'planta'});
	Usuarios.hasMany(MenusUsuarios, {foreignKey:'idUsuario', as:'menus_usuarios'});

	MenusUsuarios.belongsTo(Usuarios, {foreignKey:'idUsuario', as:'usuarios'});
	MenusUsuarios.belongsTo(MenusPaginas, {foreignKey:'idMenuPagina', as:'menu_pagina'});
	MenusPaginas.belongsTo(MenusN1, {foreignKey:'idMenuN1', as:'menu_n1'});
	MenusPaginas.belongsTo(MenusN2, {foreignKey:'idMenuN2', as:'menu_n2'});

	MenusN2.belongsTo(MenusN1, {foreignKey:'idMenuN1', as:'menu_n1'});
	...
	var models = {
		...
		menus_usuarios: MenusUsuarios,
		obras: Obras,
		operadores_maquinas: OperadoresMaquinas,
		plantas: Plantas,
		producciones: Producciones,
		productos: Productos,
		productos_consumibles: ProductosConsumibles,
...
module.exports = function dal(army) {
	...
	//var sequelize = new SequelizeMod('admin_tajsa_prod', 'root', '', {
	//var sequelize = new SequelizeMod('admin_tajsa_prod', 'admin_tajsa', 'xpThp2CTZB', {
	var sequelize = new SequelizeMod('admin_tajsa_dev', 'admin_server', 'JXAJ8D4pLBQBfdfv', {
	//var sequelize = new SequelizeMod('admin_tajsa_sync', 'army', 'A@rmy_6102', {
		//host: 'virtual.armedigital.com',
		//host: '127.0.0.1',
		// host: 'local.arme.com',
		host : '192.168.0.110',
	...
	var sequelize_server = new SequelizeMod('admin_tajsa_sync', 'root', '', {
		//host: '127.0.0.1',
		host: 'null',
		dialect: 'mysql',
		logging: null,
